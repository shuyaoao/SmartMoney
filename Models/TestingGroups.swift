...
class Family: Group {
    ...
    init() {
        ...
        self.createExpense(self.simplifier.userController.getUser("Brother")!, 95, Date(), splits, "Breakfast",  SplitType(id: "Unequally"))
...
class Friends: Group {
    ...
    init() {
        ...
        self.createExpense(self.simplifier.userController.getUser("Shuyao")!, 10000, Date(), splits, "Skincare",  SplitType(id: "Unequally"))
        ...
        self.createExpense(self.simplifier.userController.getUser("Lisa")!, 800, Date(), splits2, "Dinner",  SplitType(id: "Equally"))
...
class Hexagon : Group {
    init() {
        ...
        self.createExpense(self.simplifier.userController.getUser("Shuyao")!, 840, Date(), splits, "Breakfast",  SplitType(id: "Unequally"))
        var splits2 = [Split]()
        ...
        self.createExpense(self.simplifier.userController.getUser("Dylan")!, 60, Date(), splits2, "BubbleTea",  SplitType(id: "Unequally"))
        var splits3 = [Split]()
        ...
        self.createExpense(self.simplifier.userController.getUser("Dylan")!, 600, Date(), splits3, "Something",  SplitType(id: "Equally"))
        ...
        self.createExpense(self.simplifier.userController.getUser("Bernice")!, 250, Date(), splits4, "Something else",  SplitType(id: "UnEqually"))
        ...
        self.createExpense(self.simplifier.userController.getUser("Bernice")!, 110, Date(), splits5, "Something else 2",  SplitType(id: "UnEqually"))
        ...
        self.createExpense(self.simplifier.userController.getUser("Dylan")!, 10.89, Date(), splits6, "Something else 3",  SplitType(id: "UnEqually"))
        ...
        self.createExpense(self.simplifier.userController.getUser("Dylan")!, 540, Date(), splits7, "Something else 4",  SplitType(id: "Equally"))
        ...
        self.createExpense(self.simplifier.userController.getUser("Bernice")!, 700, Date(), splits8, "Something else 5",  SplitType(id: "Unequally"))
